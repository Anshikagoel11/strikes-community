            ...
            <DialogContent className="bg-background text-foreground p-0 overflow-hidden max-w-md sm:max-w-md">
                <DialogHeader className="pt-8 px-6">
                    ...
                    <DialogDescription className="text-center text-muted-foreground">
                        Are you sure you want to delete this server <span className="font-semibold">{server?.name}</span>?
                    </DialogDescription>
                    <p className="mt-2 text-center text-sm text-muted-foreground">You will lose all the data and all</p>
                </DialogHeader>
